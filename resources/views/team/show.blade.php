        ...
        <div class="bg-white dark:bg-gray-700 overflow-hidden shadow-sm sm:rounded-lg hover:shadow-lg transition-shadow duration-300 ease-in-out">
            <div class="p-8">
                ...
                <p class="text-lg text-gray-700 dark:text-gray-300 mb-4">
                    ...
                    {{ \Carbon\Carbon::parse($user->birthday)->locale('nl')->translatedFormat('d F Y') }}
                </p>
                <p class="text-lg text-gray-700 dark:text-gray-300 mb-4">
                        ...
                        <ul class="list-disc list-inside text-gray-700 dark:text-gray-300 ml-4">
                            @foreach ($user->degrees as $degree)
                                <li class="mb-2">
                                    ...
                                    <span class="text-gray-600 dark:text-gray-400">bij {{ $degree->school }}</span><br>
                                    <span class="ml-6 text-sm italic text-gray-700 dark:text-gray-300">
                                        {{ $degree->description }}
                                    </span>
                                </li>
                            @endforeach
