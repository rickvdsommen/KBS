        ...
        <div class="bg-white dark:bg-gray-800 shadow sm:rounded-lg p-6">
            <form method="POST" action="{{ route('projects.update', $project->id) }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="text" name="projectname" class="mt-1 block w-full rounded-md border-gray-300 dark:border-gray-700 shadow-sm focus:border-indigo-500 focus:ring-indigo-500 sm:text-sm" value="{{ $project->projectname }}" required>
                </div>
                <div class="mb-4">
