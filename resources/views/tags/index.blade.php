<x-app-layout>
    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        <div
            class="text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 shadow sm:rounded-lg p-6 mb-6 mt-6 max-w-7xl">
            <div class="mb-2">
        ...
        <div class="bg-white dark:bg-gray-800 overflow-hidden shadow-sm sm:rounded-lg p-6">
            ...
            <div class="mb-2">
                <form action="{{ route('tags.index') }}" method="GET" class="flex">
                    <input id="search" placeholder="Zoek tags..."
                        class="mb-2 w-80 rounded-md border-gray-300 dark:border-gray-700 shadow-sm" type="text"
            ...
            @else
                <ul class="space-y-4">
                    @foreach ($tags as $tag)
                        <li
                            class="flex justify-between items-center p-4 bg-gray-100 dark:bg-gray-700 rounded-lg shadow min-w-fit w-1/3">
                            <span>{{ $tag->tag }}</span>
