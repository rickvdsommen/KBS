        ...
        <div class="text-gray-900 dark:text-gray-100 bg-white dark:bg-gray-700 shadow sm:rounded-lg p-6 my-6 max-w-7xl">
            <div class="mb-2">
                ...
                <form action="{{ route('categories.store') }}" method="POST" class="flex">
                    @csrf
                    <input id="category" placeholder="Categorie" class="mb-2 w-80 rounded-md border-gray-300 dark:border-gray-700 shadow-sm" type="text" name="category" :value="old('category')" required autofocus />
