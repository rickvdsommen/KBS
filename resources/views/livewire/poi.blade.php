...
<body class="bg-gray-100">
    <div class="min-h-screen flex items-center justify-center">
        <div class="max-w-[90vw] max-h-[90vh] w-full bg-white dark:bg-gray-700 shadow sm:rounded-lg">
