<form method="POST" action="{{ route('availability.update') }}" class="rounded-lg border border-gray-200 mx-2 w-fit" id="availabilityForm">
    ...
    <div class="flex flex-col sm:flex-row">
        <label for="available" class="cursor-pointer flex-1">
            ...
            <span class="relative inline-flex h-9 items-center space-x-2 py-2 pl-7 pr-3 text-xs peer-checked:bg-green-200 rounded-md">
        ...
        <label for="busy" class="cursor-pointer flex-1">
            ...
            <span class="relative inline-flex h-9 items-center space-x-2 py-2 pl-7 pr-3 text-xs peer-checked:bg-red-200 rounded-lg">
        ...
        <label for="away" class="cursor-pointer flex-1">
            ...
            <span class="relative inline-flex h-9 items-center space-x-2 py-2 pl-7 pr-3 text-xs peer-checked:bg-gray-200 rounded-lg">
